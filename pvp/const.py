# file contains all the constants used in the PVP Agent and AI, such as action indices, 
# tile types, item types, etc.
# taken from nmmo env for neurips 2022 comepetition, with some 
# modifications for our agent design. 
