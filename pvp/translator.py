# contains the Translator class, which is responsible for translating the raw observations 
# from the NMMO environment to a structured state representation that can be fed into the 
# neural network model, and also for translating the model's output actions back into the 
# format expected by the environment!
import collections
import copy
